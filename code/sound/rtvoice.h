...
int rtvoice_start_recording(void (*user_callback)() = nullptr, unsigned int callback_time = 175 );
void rtvoice_stop_recording();
void rtvoice_get_data(unsigned char **outbuf, int *compressed_size, int *uncompressed_size, double *gain, unsigned char **outbuf_raw = nullptr, int *outbuf_size_raw = nullptr);
...
sound_handle rtvoice_play_compressed(int handle, unsigned char* data, int size, int uncompressed_size, double gain);
sound_handle rtvoice_play_uncompressed(int handle, unsigned char* data, int size);
